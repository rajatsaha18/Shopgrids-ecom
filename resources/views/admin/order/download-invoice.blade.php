...
<div class="invoice-box">
    <table>
        ...
        @foreach($order->orderDetails as $orderDetail)
            <tr class="item">
                <td>{{$order->product_name}} <img src="{{asset($orderDetail->product_image)}}" alt="" height="40" width="30"></td>
                <td style=" text-align: center;">{{$orderDetail->order_qty}}</td>
                <td style=" text-align: center;">{{$orderDetail->product_price}}</td>
                <td style=" text-align: right;">{{$orderDetail->order_qty * $orderDetail->product_price}}</td>
            </tr>
            @php($sum = $sum + $orderDetail->order_qty * $orderDetail->product_price)
        @endforeach
        ...
        <tr class="total">
            <td colspan="3"></td>
            <td>ShippingTotal: {{$order->shipping_total}}</td>
        </tr>
