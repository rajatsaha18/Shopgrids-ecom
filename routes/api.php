...
Route::get('/product-by-category/{id}',[ApiController::class, 'getProductByCategory'])->name('category-product');
Route::get('/product-by-id/{id}',[ApiController::class, 'getProductById'])->name('product-by-id');
Route::post('/new-order',[ApiController::class, 'newOrder'])->name('newOrder');
